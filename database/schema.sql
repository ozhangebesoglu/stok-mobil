...
-- İndeksler
CREATE INDEX idx_satislar_tarihi ON satislar(satis_tarihi);
CREATE INDEX idx_odemeler_tarihi ON odemeler(odeme_tarihi);
CREATE INDEX idx_stok_hareketleri_tarihi ON stok_hareketleri(islem_tarihi);
CREATE INDEX idx_giderler_tarihi ON giderler(tarih);
CREATE INDEX idx_kasa_tarihi ON kasa(tarih);
CREATE INDEX idx_musteriler_telefon ON musteriler(telefon);
CREATE INDEX idx_stoklar_urun_adi ON stoklar(urun_adi);
...
('firma_adi', 'Esnaf Defterim', 'Firma adı'),
...
('Admin', 'admin@esnafdefterim.com', '$2b$12$jGAeIAQ75OLAI19lUuWPJuosmHUBURPSHdKzVIN2egGG3Ii7Z3I0K', 'admin');